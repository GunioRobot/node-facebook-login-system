...
var db = server.db("mongoliandeadbeef")

db.auth("mongoliandeadbeef", "mongoliandeadbeef")

var small = db.collection("small"),
...
large.mapReduce(
    ...
    function reduce(key, values) {
        ...
        if (error) {
            console.warn("Error map reducing: "+error,error.stack)
        } else {
